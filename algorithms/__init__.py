...
from algorithms.GAlign import GAlign
from algorithms.PALE import PALE
from algorithms.CENALP import CENALP
from algorithms.DATAlign import DATAlign
from algorithms.HTC import HTC

__all__ = ['BigAlign', 'DeepLink', 'FINAL', 'IONE', 'IsoRank', \
           'NAWAL', 'REGAL', 'GAlign', 'PALE', 'CENALP', 'DATAlign', 'HTC']
